...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        em.setPackagesToScan("co.edu.udec.poo.gabrielaorozco.examenesacademicos.modelo.entidades");
    ...
    private Properties additionalProperties() {
        ...
        properties.setProperty("hibernate.hbm2ddl.auto", "update"); // Puedes cambiarlo a "validate" en producción
